    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-20 text-[#727277] my-40 mx-5 max-w-[1200px] md:mx-auto">
        <div className="text-[24px] min-w-[400px] mt-20">
            ...
            <p className="text-[#156DDF] text-[40px] underline underline-offset-[15px] decoration-[#1E2832] decoration-4 -mt-5">Hyundai- Pakistan</p>
        ...
        <div >
            ...
            <p className="text-[24px] mt-10">As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line. As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line.</p>
            <p className="text-[24px] mt-10">As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-20 text-white bg-[#0A2369] pt-72 lg:pt-96 pb-40 max-w-[1200px] mx-5 md:mx-auto">
        ...
        <div >
            <p className="text-[24px]">As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line. As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line.</p>
            <p className="text-[24px] mt-10">As the most awarded b2d branding agency in texas we know how to combine customer insights with impactful content to get your brand from the top of the list to the dotted line.</p>
        </div>
      </div>
      </div>
      <div className="flex flex-col xl:flex-row md:ml-20 lg:ml-40 xl:ml-60">
      <div className="flex flex-col justify-center items-start gap-20 text-[#727277] pt-72 lg:pt-96 pb-40 max-w-[1200px] mx-5 md:mx-auto">
        <div className="text-[24px] min-w-[400px]">
            <p>Creative showcase</p>
            <p className="text-[#156DDF] text-[40px] underline underline-offset-[15px] decoration-[#1E2832] decoration-4 -mt-5">How We Did This!</p>
      ...
      <img src="./portfolio/ht_sidepose.png" alt="ht" className="w-auto h-auto min-w-[450px] min-h-[200px]"/>
      </div>
      <div className="flex flex-col justify-center items-center gap-20 text-[#727277] my-40">
      <div className="text-[24px] min-w-[400px]">
            <p>Creative showcase</p>
            <p className="text-[#156DDF] text-[40px] underline underline-offset-[15px] decoration-[#1E2832] decoration-4 -mt-5">Digital Collaterals</p>
            <p className="mt-5">Digital Pressence 2.0</p>
        </div>
