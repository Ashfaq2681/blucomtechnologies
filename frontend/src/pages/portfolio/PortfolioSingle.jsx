...
const PortfolioSingle = () => {
  return (
    <div>
      <Helmet>
        <title>Blucom Technologies | Hyundai-Pakistan Portfolio Case Study</title>
        <meta
          name="description"
          content="Explore Blucom Technologies' Hyundai-Pakistan portfolio case study covering digital creatives, impact analysis, and digital presence."
        />
        <meta
          name="keywords"
          content="Hyundai Pakistan case study, digital creatives, branding, impact analysis, web design, digital presence, marketing agency"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Blucom Technologies | Hyundai-Pakistan Portfolio Case Study" />
        <meta property="og:description" content="Explore our Hyundai-Pakistan work in branding, impact analysis, and digital presence." />
        <meta property="og:image" content="https://blucomtechnologies.com/portfolio/cover.jpg" />
        <meta property="og:url" content="https://blucomtechnologies.com/portfolio/single" />
        <link rel="canonical" href="https://blucomtechnologies.com/portfolio/single" />
      </Helmet>
