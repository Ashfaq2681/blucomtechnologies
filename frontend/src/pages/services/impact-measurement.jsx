    ...
    <div className="bg-white text-[#011f18] font-sans selection:bg-[#00FFC2] overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center px-6 pt-20 bg-gradient-to-tr from-[#00FFC2]/30 to-[#00AE80]/20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center z-10">
          <div>
            ...
            <p className="text-xl md:text-2xl text-gray-500 font-light leading-relaxed mb-10 max-w-xl">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white border border-gray-200 p-10 shadow-md space-y-8">
               <div className="flex justify-between items-center">
                  <span className="font-black text-xs tracking-widest text-gray-500 italic">ROI correlation</span>
      ...
      <section className="py-32 px-6 bg-gray-50 border-y border-gray-200">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-lg leading-relaxed mb-16 italic">
             ...
             <div className="bg-white p-12 shadow-md border border-gray-200">
                ...
                <div className="flex items-center gap-6">
                   <div className="text-center">
                      ...
                      <span className="text-[9px] font-bold tracking-widest text-gray-500">ROI growth</span>
                   </div>
                   <div className="w-px h-10 bg-gray-200"></div>
                   <div className="text-center">
                      <span className="block text-2xl font-black text-[#00AE80]">3mo</span>
                      <span className="text-[9px] font-bold tracking-widest text-gray-500">duration</span>
                   </div>
                </div>
             </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <p className="text-gray-500 max-w-sm text-xs font-bold tracking-widest leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-24">
            ...
            <div className="bg-white/5 border border-white/10 p-12 text-center">
               ...
               <input type="email" placeholder="Your Business Email" className="w-full bg-white/10 border border-white/20 px-8 py-4 mb-4 text-xs font-bold placeholder:text-gray-600 focus:outline-none focus:border-[#00FFC2]" />
          ...
          <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] font-black tracking-[1em] text-gray-500">
