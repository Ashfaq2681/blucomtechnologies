  ...
  return (
    <div>
      ...
      <div className="dashboard-page-stack">
        ...
        <PageIntro
          eyebrow="UI Elements"
          title="Badge treatments for statuses and counts"
          description="This page now groups the badge variations into cleaner presentation blocks so the differences are easier to scan."
        />
