          ...
          <div className="rounded-[30px] border border-slate-200 bg-white p-6">
            ...
            <div className="relative py-3 sm:py-5">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white p-2 text-slate-400 sm:px-5 sm:py-2">
                  Or
                </span>
              </div>
            </div>
            <form>
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <p className="inline-block font-normal text-slate-500">
            ...
            <div className="mt-5">
              <p className="text-center text-sm font-normal text-slate-600 sm:text-start">
