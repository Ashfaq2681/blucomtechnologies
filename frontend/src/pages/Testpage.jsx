...
const InteractiveForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-emerald-100 text-emerald-950 font-sans flex flex-col relative overflow-hidden selection:bg-emerald-200 selection:text-emerald-900">
      ...
      {/* Progress Bar */}
      <div className="fixed top-0 left-0 w-full h-3 bg-emerald-200 z-50">
        <motion.div
        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            <div className="mt-12 flex justify-center items-center gap-6">
              ...
              {step === steps.length && (
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-4 bg-gradient-to-r from-emerald-200 to-emerald-400 text-emerald-950 font-black  -full shadow-md hover:shadow-lg transition-all uppercase">
                  Launch Request
                </motion.button>
              )}
            </div>
