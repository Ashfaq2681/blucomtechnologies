...
export default function InvestorsOverview() {
  return (
    <div className="">
      ...
      <div className="">
      <div className="flex sm:flex-row flex-col justify-between bg-[#298063] rounded-md pl-2 items-center w-60 sm:w-80 sticky top-12 left-full">
            ...
            <div className=" text-gray-200 p-4 rounded">
              ...
              <h2 className="text-2xl font-medium underline text-white">
                Global AI Index
              </h2>
              ...
              <button className="bg-gray-100 text-[#298063] mt-2 p-1 w-full">
                Download Now
              </button>
            </div>
          </div>
        <div className="w-[80%] mx-auto lg:my-48 my-10 sm:my-14 md:my-28">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-full justify-center gap-8 ">
            <div className="w-full sm:w-52 text-gray-600 p-1">
              ...
              <p>Performance</p>
              <h2 className="text-[#10b981] text-4xl font-medium underline">
                Q1
              </h2>
        ...
        <div className="w-[80%] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
            <div className="text-gray-600 p-1">
              <p>Some of our </p>
              <h2 className="text-[#10b981] text-4xl font-medium underline py-1">
                Presentations
              </h2>
              <p> Risk Takers, opportunity makers</p>
              <ul className="text-[#10b981] pt-6">
            ...
            <div className="text-gray-600">
              <p>Some of our </p>
              <h2 className="text-[#10b981] text-4xl font-medium underline pt-1 pb-4">
                Events
              </h2>
              ...
              <div className="">
                <h2 className="text-4xl font-medium underline py-2">
