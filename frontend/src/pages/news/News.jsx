...
import aimarketing from "./Marketing-in-behavioural-science.png"
import futureimg from "./future_branding.png"
  ...
  return (
    <main>
      ...
      <section className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col lg:flex-row justify-center items-center text-white p-4">
          <div className="w-full lg:w-[35%] lg:p-4 p-2 text-center lg:text-right">
          ...
          <div className="w-full sm:w-[35%] border-t lg:border-t-0 lg:border-l-2 border-white lg:p-4 p-2 text-center lg:text-left mt-4 lg:mt-0">
            <img
              src="/news/adobe.png "
              alt="Adobe Summit Logo"
              className="mx-auto lg:mx-0 lg:w-72 md:w-60 sm:w-40 w-24"
              loading="lazy"
            />
          </div>
        </div>
      ...
      {/* News Section */}
      <section className="w-[90%] lg:w-[80%] mx-auto my-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {news.slice(0, showMore ? news.length : 4).map((newsItem, index) => (
            <article className="text-gray-600" key={index}>
              ...
              <div className="h-60 bg-gray-300 overflow-hidden rounded-lg">
                <img
                  src={newsItem.image}
                  alt={newsItem.title}
