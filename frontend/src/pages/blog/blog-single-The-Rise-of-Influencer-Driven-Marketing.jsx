...
export default function BlogSingle() {
  ...
  const schemaMarkup = {
    ...
    "@type": "Article",
    "headline": "The Shift Towards Commerce-Driven Marketing: Bridging Online and Offline Experiences",
    "description": "Commerce-driven marketing is transforming the way businesses connect with consumers, blending online and offline experiences for seamless shopping journeys.",
    "author": {
      "@type": "Person",
      "name": "Polly Row"
    },
    ...
    "image": "https://blucomtechnologies/images/commerce.jpg",
...
return (
  <div>
    ...
    <Helmet>
      <title>The Shift Towards Commerce Driven Marketing Bridging Online and Offline Experiences</title>
      <meta name="description" content="Commerce-driven marketing is transforming the way businesses connect with consumers, blending online and offline experiences for seamless shopping journeys." />
      <meta name="keywords" content="Commerce-driven marketing, Omnichannel retail strategies, Consumer behavior trends, Personalization in marketing, Retail media networks, Digital payments innovation, Phygital store experiences, Data-driven marketing, Customer engagement strategies" />
    ...
    <div className="relative w-full">
      ...
      <div className="absolute inset-0 flex flex-col sm:flex-row justify-center items-center text-white p-4">
        <div className="sm:w-[35%] w-full lg:p-4 p-2 text-right">
          ...
          <h1 className="text-lg sm:text-2xl lg:text-4xl">Brands must adapt to evolving consumer expectations.
        ...
        <div className="sm:w-[35%] w-full sm:border-l-2 border-t-2 sm:border-t-0 border-white lg:p-4 p-2 text-left mt-4 lg:mt-0">
          <p className="text-xs sm:text-base">
            ...
            Commerce-driven marketing is at the forefront of this transformation, leveraging data-driven insights and technology to enhance the customer journey across
      ...
      <div className="bg-[#00AE80]  md:py-20 py-10">
        <div className="w-[80%] mx-auto">
          <div className="text-gray-100">
            <p>The Rise of Omnichannel Consumer Behavior
            </p>
