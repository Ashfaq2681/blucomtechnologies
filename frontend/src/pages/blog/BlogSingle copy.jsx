...
export default function BlogSingle() {
  ...
  const schemaMarkup = {
    ...
    "description": "When done right, social proof isn’t just persuasive—it’s downright irresistible.",
    "author": {"@type": "Person", "name": "Polly Row"},
    "publisher": {
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta name="description" content="When done right, social proof isn’t just persuasive—it’s downright irresistible." />
        <meta name="keywords" content= "The Psychology of Social Proof  Why It Works The Science of Persuasion: How Behavioral
                                        Economics Shapes Advertising Success, digital marketing, B2B branding, impact analysis,
                                        customer insights, Blucom Technologies"/>
